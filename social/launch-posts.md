...
It got **16/20**: strong on task scope, permissions, evals, observability, human review, and docs; still weak on memory, recovery, security, and cost controls.

Score yours in the browser, no signup:

https://lindixu6-hash.github.io/awesome-agentic-engineering/?scores=2212112122

The rubric, templates, failure cases, and CLI are open source:
...
## Chinese Score Challenge

我用10项生产就绪标准给一个 Coding Agent 打了分。

结果是 **16/20**：任务边界、权限、评估、可观测性、人工审核和文档做得不错；记忆、失败恢复、安全和成本控制还不够。

不注册，直接在线给你的 Agent 打分：

https://lindixu6-hash.github.io/awesome-agentic-engineering/?scores=2212112122

评分标准、模板、生产事故案例和 CLI 都已开源：
